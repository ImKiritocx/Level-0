...
public class DontForgetTheLyrics {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "all you have to do is type the lyrics that follows after the song stops playing, GL HF");
		// 5. Use the playSound method to play your song.
		playSound("Song.wav");
		// 6. Make a pop-up for the player to type their answer.
		String answer = JOptionPane.showInputDialog("type the lyrics");
		// 7. If they answered correctly, tell them that they were right.
		if (answer.equalsIgnoreCase("We will we will rock you")) {
			JOptionPane.showMessageDialog(null, "You are correct !");
		}
		// 8. Otherwise, tell them they are wrong, and give them the answer.
		else {
			JOptionPane.showMessageDialog(null, "you were wrong , the answer was \"We will we will rock you \" ");
		}
