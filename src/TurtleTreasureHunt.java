...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if (tortoiseLocationX > 480  && tortoiseLocationX < 520 && tortoiseLocationY > 290 && tortoiseLocationY < 352 ) {
			JOptionPane.showMessageDialog(null, "I have been tied up ! please help. Go to the parrots to see if you can get any information.");
		}

		// 7. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if (tortoiseLocationX > 400 && tortoiseLocationX < 480 && tortoiseLocationY > 90 && tortoiseLocationY < 120 ) {
			JOptionPane.showMessageDialog(null, " She tied herself up just to get your attention lol.");
		}
